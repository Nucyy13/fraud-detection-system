...
from .views import base,delete_data,upload_data,predict_csv_single,predict_csv_multi,predict_data_manually,retrieve_data_by_id,analysis,change_password,login2,account_details,add_files_multi,about,dashboard,userLogout,reports,upload_credit_data,prediction_button,enter_form_data_manually,add_files_single
from . import views
...
urlpatterns = [
    ...
    path('cardverifier/', views.cardverifier, name='cardverifier'),
